            ...
            if (data.length > 0) {
              ...
              $.each(data, function(index, item) {
                ...
                for (var month = 1; month <= 12; month++) {
                  let qty = 1;
                  let totalValue = (item['MONTH' + month + '_QTY'] * qty); // แสดงทศนิยม 2 ตำแหน่ง
                  let forcast = ((item.qty_local + item.qty_boi) * qty);
                  //forcast
                  if (totalValue === 0) {
                    htmlCode += "<td style='width:100px;'></td>";
                  } else {
                    htmlCode += "<td style='width:100px;'>" + totalValue.toFixed(2) + "</td>";
                  }
                  ...
                  //balance
                  balance = stock - reduce - totalTotalValue;
