        ...
        $(document).ready(function() {
            ...
            function fetchData() {
                ...
                $.ajax({
                        ...
                        if (data.length > 0) {
                            ...
                            $.each(data, function(index, item) {
                                ...
                                for (var month = 1; month <= 12; month++) {
                                    let qty = 1;
                                    let boiValue = (item['MONTH' + month + '_QTY'] * qty); // แสดงทศนิยม 2 ตำแหน่ง
                                    let forcast = (item.qty_boi * qty);
                                    //forcast
                                    if (boiValue === 0) {
                                        htmlCode += "<td style='width:100px;'></td>";
                                    } else {
                                        htmlCode += "<td style='width:100px;'>" + boiValue.toFixed(2) + "</td>";
                                    }
                                    ...
                                    reduce = forcast;
                                    totalBoiValue = totalBoiValue + boiValue;
                                    //balance
                                    balance = stock - reduce - totalBoiValue;
                                    // htmlCode += "<td>" + balance.toFixed(2) + "</td>";
                                ...
                                $("#data3").append(
                                    ...
                                    "<td contenteditable='true' id='priceboi_" + index + "' class='editable-cell-price'>" + (item.price_boi === 0 ? '' : item.price_boi) + "</td>" +
                    ...
                    //     console.log(xhr.responseText); // Print the response from the server for more details
                    // }
                });
            }
