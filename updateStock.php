<?php
// Your PHP code for updateStock.php
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $pdo->prepare("UPDATE material_lists SET stock".$stock_id."_".$type." = :newQty, update_by = :updateBy, UPDATE_DATE = :currentDate WHERE material = :material");
